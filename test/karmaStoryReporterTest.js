...
describe("Karma story reporter", function() {
    ...
    describe("configuration options", function() {
        ...
        it("can enable skipped tests", function() {
            var thisStoryReporter = new StoryReporter(baseReporterDecorator, {
                storyConfigReporter: {
                    showSkipped: true
                }
        ...
        it("Can change color of passed and failure tests", function() {
            var thisStoryReporter = new StoryReporter(baseReporterDecorator, {
                storyConfigReporter: {
                    colors: {
                        passedHeader: 'green',
            ...
            expect(thisStoryReporter.colorsConfig).toBeTruthy();
        });

        it("Can enable show bullets for each spec", function() {
        		var thisStoryReporter = new StoryReporter(baseReporterDecorator, {
                storyConfigReporter: {
                    showBullets: true
                }
            ...
            expect(thisStoryReporter.showBullets).toBeTruthy();
        });
    ...
    using("spec sets", [
            [
                [{
                    "id": 0,
                    "description": "has a passing child test",
                    "suite": ["Initial spec"],
                    "success": true,
                    "skipped": false,
                    "time": 3,
            ...
            [
                [{
                    ...
                    "id": 1,
                    "description": "has a first test that passes",
                    "suite": ["Story reporter"],
                    "success": true,
                    "skipped": false,
                    "time": 0,
                    "log": []
            ...
            [
                [{
                    ...
                    "id": 2,
                    "description": "has a first test that fails",
                    "suite": ["Story reporter"],
                    "success": false,
                    "skipped": false,
                    "time": 0,
                    "log": ["Expected true to be falsy."]
                }, {
                    "id": 3,
                    "description": "has a passing child test",
                    "suite": ["Story reporter", "nested spec"],
                    "success": true,
                    "skipped": false,
                    "time": 0,
                    "log": []
                    ...
                    "id": 4,
                    "description": "has an initial test that passes",
                    "suite": ["Story reporter", "with deeply nested spec"],
                    "success": true,
                    "skipped": false,
                    "time": 0,
                    "log": []
                    ...
                    "skipped": false,
                    "time": 0,
                    "log": ["Expected null not to be null."]
                }, {
                    "id": 6,
                    "description": "has a passing child test",
                    "suite": ["Story reporter", "with deeply nested spec", "nested further"],
                    "success": true,
                    "skipped": false,
                    "time": 0,
                    "log": []
                    ...
                    "id": 7,
                    "description": "has a passing child test",
                    "suite": ["Story reporter", "with deeply nested spec", "nested further", "and even further"],
                    "success": true,
                    "skipped": false,
                    "time": 0,
                    "log": []
                    ...
                    "id": 8,
                    "description": "passes this test",
                    "suite": ["Story reporter", "with deeply nested spec", "with a failing child spec"],
                    "success": true,
                    "skipped": false,
                    "time": 0,
                    "log": []
                    ...
                    "suite": ["Story reporter", "with deeply nested spec", "with a failing child spec", "with failing test"],
                    "success": false,
                    "skipped": false,
                    "time": 0,
                    "log": ["Expected false to be truthy."]
                }, {
                    "id": 10,
                    "description": "passes this test",
                    "suite": ["Story reporter", "with deeply nested spec", "with a failing child spec", "with failing test", "child of failing test"],
                    "success": true,
                    "skipped": false,
                    "time": 0,
                    "log": []
            ...
            [
                [{
                    ...
                    "id": 1,
                    "description": "has test C",
                    "suite": ["Block A", "Block B", "Block C"],
                    "success": true,
                    "skipped": false,
                    "time": 0,
                    "log": []
            ...
            [
                [{
                    ...
                    "id": 1,
                    "description": "has test G",
                    "suite": ["Nested spec D", "Nested spec E", "Nested spec F", "Nested spec G"],
                    "success": true,
                    "skipped": false,
                    "time": 0,
                    "log": []
                    ...
                    "id": 2,
                    "description": "has test K",
                    "suite": ["Nested spec D", "Nested spec E", "Nested spec F", "Nested spec G", "Nested spec F", "Nested spec J", "Nested spec K"],
                    "success": true,
                    "skipped": false,
                    "time": 0,
                    "log": []
            ...
            [
                [{
                    ...
                    "id": 1,
                    "description": "has test B",
                    "suite": ["Root suite", "Nested Suite"],
                    "success": true,
                    "skipped": false,
                    "time": 0,
                    "log": []
            ...
            [
                [{
                    "id": 0,
                    "description": "has a passing child test",
                    "suite": ["Initial spec", "Initial spec 2"],
                    "success": true,
                    "skipped": false,
                    "time": 3,
                    "log": []
